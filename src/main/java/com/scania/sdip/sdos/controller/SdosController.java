package com.scania.sdip.sdos.controller;

import static com.scania.sdip.sdos.utils.Utility.modelToJsonLd;
import static com.scania.sdip.sdos.utils.Utility.modelToN3;
import static com.scania.sdip.sdos.utils.Utility.modelToNQuads;
import static com.scania.sdip.sdos.utils.Utility.modelToNTriples;
import static com.scania.sdip.sdos.utils.Utility.modelToRdfXml;
import static com.scania.sdip.sdos.utils.Utility.modelToTurtle;

import com.google.gson.JsonObject;
import com.scania.sdip.sdos.model.OrchestrationRequestModel;
import com.scania.sdip.sdos.orchestration.ParameterMemory;
import com.scania.sdip.sdos.orchestration.model.ResultMetaDataModel;
import com.scania.sdip.sdos.services.ControllerService;
...
public class SdosController {
  ...
  @PostMapping(value = "/test/runSingleAction")
  @Operation(summary = "run a single Orchestration Action.")
  @ResponseBody
  public ResponseEntity<String> testRunSingleAction(
      @RequestBody() @Valid OrchestrationRequestModel param) {
    return new ResponseEntity<>("result", HttpStatus.OK);
  }

//TODO ENDPOINTS TO ADD, TESTRUNORCHESTRATION, MAYBE TESTBUILDMODEL
