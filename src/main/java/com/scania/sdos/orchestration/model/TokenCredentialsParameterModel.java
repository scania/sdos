...
public class TokenCredentialsParameterModel implements IParameterModel {

  private static final Logger LOGGER = LogManager.getLogger(TokenCredentialsParameterModel.class);
  ...
  public static final String SPARQL =
          SDOSConstants.PREFIX_RDF +
                  ...
                  "?subject rdf:type :TokenCredentialsParameter .\n" +
                  "?subject rdfs:label ?label .\n" +
                  "}";

  public TokenCredentialsParameterModel() {
  ...
  public HashMap getValue() {
    ...
    hashMap.put(SDOSConstants.TOKEN, getToken());
    return hashMap;
  }
  ...
  public JsonArray createUserInputHelp() {
    ...
    usernameObject.addProperty(SDOSConstants.KEY, "token");
